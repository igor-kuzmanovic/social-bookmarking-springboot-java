...
INSERT INTO `socbook1`.`bookmark`(`title`, `url`, `date`, `description`, `is_public`, `imported`, `category_id`, `user_id`, `rating`, `times_rated`, `rate_sum`) VALUES ('Google', 'https://www.google.com', '2012-07-15 23:59:59', 'Google home page', TRUE, FALSE, 1, 1, 5, 1, 5);
INSERT INTO `socbook1`.`bookmark`(`title`, `url`, `date`, `description`, `is_public`, `imported`, `category_id`, `user_id`, `rating`, `times_rated`, `rate_sum`) VALUES ('Facebook', 'https://www.facebook.com', '2013-01-12 23:59:59', 'Facebook home page', TRUE, FALSE, 2, 2, 4, 1, 4);
INSERT INTO `socbook1`.`bookmark`(`title`, `url`, `date`, `description`, `is_public`, `imported`, `category_id`, `user_id`, `rating`, `times_rated`, `rate_sum`) VALUES ('Instagram', 'https://www.instagram.com', '2015-11-02 23:59:59', 'Instagram home page', TRUE, FALSE, 2, 3, 3, 1, 3);
INSERT INTO `socbook1`.`bookmark`(`title`, `url`, `date`, `description`, `is_public`, `imported`, `category_id`, `user_id`, `rating`, `times_rated`, `rate_sum`) VALUES ('YouTube', 'https://www.youtube.com', '2016-12-03 23:59:59', 'YouTube home page', TRUE, FALSE, 3, 1, 2, 1, 2);
INSERT INTO `socbook1`.`bookmark`(`title`, `url`, `date`, `description`, `is_public`, `imported`, `category_id`, `user_id`, `rating`, `times_rated`, `rate_sum`) VALUES ('Twitter', 'https://www.twitter.com', '2011-05-29 23:59:59', 'Twitter home page', TRUE, FALSE, 2, 3, 1, 1, 1);
