...
INSERT INTO `socbook1`.`bookmark`(`title`, `url`, `date`, `description`, `is_public`, `imported`, `category_id`, `user_id`, `times_rated`, `rating`) VALUES ('Instagram', 'https://www.instagram.com', '2015-11-02 23:59:59', 'Instagram home page', TRUE, FALSE, 2, 2, 0, 0);
INSERT INTO `socbook1`.`bookmark`(`title`, `url`, `date`, `description`, `is_public`, `imported`, `category_id`, `user_id`, `times_rated`, `rating`) VALUES ('YouTube', 'https://www.youtube.com', '2016-12-03 23:59:59', 'YouTube home page', TRUE, FALSE, 3, 3, 0, 0);
...
INSERT INTO `socbook1`.`comment`(`content`,`date`,`user_id`, `bookmark_id`) VALUES ('bookmark is good','2016-12-03 23:59:59',1, 1);
INSERT INTO `socbook1`.`comment`(`content`,`date`,`user_id`, `bookmark_id`) VALUES ('bookmark is better','2016-12-03 23:59:59',1, 1);