...
INSERT INTO `socbook1`.`bookmark`(`title`, `url`, `date`, `description`, `visibility`, `imported`, `category_id`, `user_id`) VALUES ('google', 'http://www.google.com', '9999-12-31 23:59:59', 'asdasdasdasd', TRUE, TRUE, 1, 1);
